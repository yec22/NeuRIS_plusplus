...
if __name__ == '__main__':
    ...
    if args.mode == 'eval_3D_mesh_metrics':
        ...
        path_mesh_pred = f'exps/indoor/neus/{scene_name}/exp_{prefix}_plus/meshes/000{args.iter}_reso{args.reso}_{scene_name}_world.ply'
    ...
    if args.mode == 'eval_mesh_2D_metrices':
        ...
        count = 0
        str_date = datetime.now().strftime("%Y-%m-%d_%H-%M")
        path_log_all = f'./exps/indoor/neus/results_{name_baseline}-scale_{scale_depth}_{eval_type_baseline}_{str_date}.txt'
